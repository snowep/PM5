...
<html lang="en" dir="ltr">
  <head>
<title>Input Asset Switch</title>
    <meta charset="utf-8">
        ...
        <!-- start: Header -->
          ...
          <div id="sidebar-left" class="span2">
            ...
            <ul class="breadcrumb">
              ...
              <li><a href="#">Input_Asset_Switch</a></li>
            </ul>
                  ...
                  <div class="ui segment">
                    ...
                    <div class="fields">
                                          <div class="field">
                                            ...
                                            <input type="text" name="nama_switch" placeholder="Nama switch">
                                          </div>
                                          <div class="field">

                                            <input type="text" name="switch_type" placeholder="Tipe switch">
                                          </div>
  ...
  <div class="fields">
                      ...
                      <div class="field">
                        ...
                        <input type="text" name="merk" placeholder="Merek">
                      </div>
                    </div>
...
<div class="fields">
                      ...
                      <div class="field">
                        ...
                        <input type="text" name="jumlah_port" placeholder="Jumlah port">
                      </div>
